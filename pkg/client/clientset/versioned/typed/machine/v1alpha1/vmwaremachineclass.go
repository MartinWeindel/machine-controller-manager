...
type VMwareMachineClassInterface interface {
	Create(*v1alpha1.VMwareMachineClass) (*v1alpha1.VMwareMachineClass, error)
	Update(*v1alpha1.VMwareMachineClass) (*v1alpha1.VMwareMachineClass, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.VMwareMachineClass, error)
	List(opts v1.ListOptions) (*v1alpha1.VMwareMachineClassList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VMwareMachineClass, err error)
...
func newVMwareMachineClasses(c *MachineV1alpha1Client, namespace string) *vMwareMachineClasses {
...
func (c *vMwareMachineClasses) Get(name string, options v1.GetOptions) (result *v1alpha1.VMwareMachineClass, err error) {
	result = &v1alpha1.VMwareMachineClass{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *vMwareMachineClasses) List(opts v1.ListOptions) (result *v1alpha1.VMwareMachineClassList, err error) {
	result = &v1alpha1.VMwareMachineClassList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vmwaremachineclasses").
...
func (c *vMwareMachineClasses) Create(vMwareMachineClass *v1alpha1.VMwareMachineClass) (result *v1alpha1.VMwareMachineClass, err error) {
	result = &v1alpha1.VMwareMachineClass{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vmwaremachineclasses").
...
func (c *vMwareMachineClasses) Update(vMwareMachineClass *v1alpha1.VMwareMachineClass) (result *v1alpha1.VMwareMachineClass, err error) {
	result = &v1alpha1.VMwareMachineClass{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vmwaremachineclasses").
...
func (c *vMwareMachineClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.VMwareMachineClass, err error) {
	result = &v1alpha1.VMwareMachineClass{}
