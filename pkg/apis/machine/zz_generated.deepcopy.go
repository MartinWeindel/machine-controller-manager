...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareClone) DeepCopyInto(out *VMwareClone) {
	*out = *in
	if in.Timeout != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareClone.
func (in *VMwareClone) DeepCopy() *VMwareClone {
	if in == nil {
		return nil
	}
	out := new(VMwareClone)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareDisk) DeepCopyInto(out *VMwareDisk) {
	*out = *in
	if in.MoreProperties != nil {
		in, out := &in.MoreProperties, &out.MoreProperties
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareDisk.
func (in *VMwareDisk) DeepCopy() *VMwareDisk {
	if in == nil {
		return nil
	}
	out := new(VMwareDisk)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareMachineClass) DeepCopyInto(out *VMwareMachineClass) {
	*out = *in
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	out.TypeMeta = in.TypeMeta
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareMachineClass.
func (in *VMwareMachineClass) DeepCopy() *VMwareMachineClass {
	if in == nil {
		return nil
	}
	out := new(VMwareMachineClass)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VMwareMachineClass) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareMachineClassList) DeepCopyInto(out *VMwareMachineClassList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	out.ListMeta = in.ListMeta
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]VMwareMachineClass, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareMachineClassList.
func (in *VMwareMachineClassList) DeepCopy() *VMwareMachineClassList {
	if in == nil {
		return nil
	}
	out := new(VMwareMachineClassList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *VMwareMachineClassList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareMachineClassSpec) DeepCopyInto(out *VMwareMachineClassSpec) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
	...
	if in.NetworkInterfaces != nil {
		in, out := &in.NetworkInterfaces, &out.NetworkInterfaces
		*out = make([]*VMwareNetworkInterface, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(VMwareNetworkInterface)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareMachineClassSpec.
func (in *VMwareMachineClassSpec) DeepCopy() *VMwareMachineClassSpec {
	if in == nil {
		return nil
	}
	out := new(VMwareMachineClassSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareNetworkInterface) DeepCopyInto(out *VMwareNetworkInterface) {
	*out = *in
	if in.Properties != nil {
		in, out := &in.Properties, &out.Properties
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareNetworkInterface.
func (in *VMwareNetworkInterface) DeepCopy() *VMwareNetworkInterface {
	if in == nil {
		return nil
	}
	out := new(VMwareNetworkInterface)
