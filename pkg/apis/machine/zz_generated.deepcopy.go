...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VMwareSystemDisk) DeepCopyInto(out *VMwareSystemDisk) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VMwareSystemDisk.
func (in *VMwareSystemDisk) DeepCopy() *VMwareSystemDisk {
	if in == nil {
		return nil
	}
	out := new(VMwareSystemDisk)
