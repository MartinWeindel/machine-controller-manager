...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*VApp)(nil), (*machine.VApp)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VApp_To_machine_VApp(a.(*VApp), b.(*machine.VApp), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VApp)(nil), (*VApp)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VApp_To_v1alpha1_VApp(a.(*machine.VApp), b.(*VApp), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*VMwareClone)(nil), (*machine.VMwareClone)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VMwareClone_To_machine_VMwareClone(a.(*VMwareClone), b.(*machine.VMwareClone), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VMwareClone)(nil), (*VMwareClone)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VMwareClone_To_v1alpha1_VMwareClone(a.(*machine.VMwareClone), b.(*VMwareClone), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*VMwareDisk)(nil), (*machine.VMwareDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VMwareDisk_To_machine_VMwareDisk(a.(*VMwareDisk), b.(*machine.VMwareDisk), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VMwareDisk)(nil), (*VMwareDisk)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VMwareDisk_To_v1alpha1_VMwareDisk(a.(*machine.VMwareDisk), b.(*VMwareDisk), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*VMwareNetworkInterface)(nil), (*machine.VMwareNetworkInterface)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_VMwareNetworkInterface_To_machine_VMwareNetworkInterface(a.(*VMwareNetworkInterface), b.(*machine.VMwareNetworkInterface), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*machine.VMwareNetworkInterface)(nil), (*VMwareNetworkInterface)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_machine_VMwareNetworkInterface_To_v1alpha1_VMwareNetworkInterface(a.(*machine.VMwareNetworkInterface), b.(*VMwareNetworkInterface), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_VApp_To_machine_VApp(in *VApp, out *machine.VApp, s conversion.Scope) error {
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_v1alpha1_VApp_To_machine_VApp is an autogenerated conversion function.
func Convert_v1alpha1_VApp_To_machine_VApp(in *VApp, out *machine.VApp, s conversion.Scope) error {
	return autoConvert_v1alpha1_VApp_To_machine_VApp(in, out, s)
}

func autoConvert_machine_VApp_To_v1alpha1_VApp(in *machine.VApp, out *VApp, s conversion.Scope) error {
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_machine_VApp_To_v1alpha1_VApp is an autogenerated conversion function.
func Convert_machine_VApp_To_v1alpha1_VApp(in *machine.VApp, out *VApp, s conversion.Scope) error {
	return autoConvert_machine_VApp_To_v1alpha1_VApp(in, out, s)
}

func autoConvert_v1alpha1_VMwareClone_To_machine_VMwareClone(in *VMwareClone, out *machine.VMwareClone, s conversion.Scope) error {
	out.TemplateUuid = in.TemplateUuid
	out.LinkedClone = in.LinkedClone
	out.Timeout = (*int)(unsafe.Pointer(in.Timeout))
	return nil
}

// Convert_v1alpha1_VMwareClone_To_machine_VMwareClone is an autogenerated conversion function.
func Convert_v1alpha1_VMwareClone_To_machine_VMwareClone(in *VMwareClone, out *machine.VMwareClone, s conversion.Scope) error {
	return autoConvert_v1alpha1_VMwareClone_To_machine_VMwareClone(in, out, s)
}

func autoConvert_machine_VMwareClone_To_v1alpha1_VMwareClone(in *machine.VMwareClone, out *VMwareClone, s conversion.Scope) error {
	out.TemplateUuid = in.TemplateUuid
	out.LinkedClone = in.LinkedClone
	out.Timeout = (*int)(unsafe.Pointer(in.Timeout))
	return nil
...
// Convert_machine_VMwareClone_To_v1alpha1_VMwareClone is an autogenerated conversion function.
func Convert_machine_VMwareClone_To_v1alpha1_VMwareClone(in *machine.VMwareClone, out *VMwareClone, s conversion.Scope) error {
	return autoConvert_machine_VMwareClone_To_v1alpha1_VMwareClone(in, out, s)
}

func autoConvert_v1alpha1_VMwareDisk_To_machine_VMwareDisk(in *VMwareDisk, out *machine.VMwareDisk, s conversion.Scope) error {
	out.Label = in.Label
	out.Size = in.Size
	out.Attach = in.Attach
	out.KeepOnRemove = in.KeepOnRemove
	out.UnitNumber = in.UnitNumber
	out.MoreProperties = *(*map[string]string)(unsafe.Pointer(&in.MoreProperties))
	return nil
}

// Convert_v1alpha1_VMwareDisk_To_machine_VMwareDisk is an autogenerated conversion function.
func Convert_v1alpha1_VMwareDisk_To_machine_VMwareDisk(in *VMwareDisk, out *machine.VMwareDisk, s conversion.Scope) error {
	return autoConvert_v1alpha1_VMwareDisk_To_machine_VMwareDisk(in, out, s)
}

func autoConvert_machine_VMwareDisk_To_v1alpha1_VMwareDisk(in *machine.VMwareDisk, out *VMwareDisk, s conversion.Scope) error {
	out.Label = in.Label
	out.Size = in.Size
	out.Attach = in.Attach
	out.KeepOnRemove = in.KeepOnRemove
...
// Convert_machine_VMwareDisk_To_v1alpha1_VMwareDisk is an autogenerated conversion function.
func Convert_machine_VMwareDisk_To_v1alpha1_VMwareDisk(in *machine.VMwareDisk, out *VMwareDisk, s conversion.Scope) error {
	return autoConvert_machine_VMwareDisk_To_v1alpha1_VMwareDisk(in, out, s)
}
...
func autoConvert_v1alpha1_VMwareMachineClassSpec_To_machine_VMwareMachineClassSpec(in *VMwareMachineClassSpec, out *machine.VMwareMachineClassSpec, s conversion.Scope) error {
	...
	out.UserData = in.UserData
	out.SecretRef = (*v1.SecretReference)(unsafe.Pointer(in.SecretRef))
	out.ResourcePoolId = in.ResourcePoolId
	out.DatastoreId = in.DatastoreId
	out.Folder = in.Folder
	out.HostSystemId = in.HostSystemId
	out.NumCpus = in.NumCpus
	out.Memory = in.Memory
	out.GuestId = in.GuestId
	out.NetworkInterfaces = *(*[]*machine.VMwareNetworkInterface)(unsafe.Pointer(&in.NetworkInterfaces))
	out.Disks = *(*[]*machine.VMwareDisk)(unsafe.Pointer(&in.Disks))
	if err := Convert_v1alpha1_VMwareClone_To_machine_VMwareClone(&in.Clone, &out.Clone, s); err != nil {
		return err
	}
	out.VApp = (*machine.VApp)(unsafe.Pointer(in.VApp))
	out.WaitForGuestNetTimeout = (*int)(unsafe.Pointer(in.WaitForGuestNetTimeout))
	out.ShutdownWaitTimeout = (*int)(unsafe.Pointer(in.ShutdownWaitTimeout))
	out.RebootRequired = in.RebootRequired
	out.LatencySensitivity = in.LatencySensitivity
	out.MoreProperties = *(*map[string]string)(unsafe.Pointer(&in.MoreProperties))
	return nil
}
...
func autoConvert_machine_VMwareMachineClassSpec_To_v1alpha1_VMwareMachineClassSpec(in *machine.VMwareMachineClassSpec, out *VMwareMachineClassSpec, s conversion.Scope) error {
	...
	out.Memory = in.Memory
	out.GuestId = in.GuestId
	out.NetworkInterfaces = *(*[]*VMwareNetworkInterface)(unsafe.Pointer(&in.NetworkInterfaces))
	out.Disks = *(*[]*VMwareDisk)(unsafe.Pointer(&in.Disks))
	if err := Convert_machine_VMwareClone_To_v1alpha1_VMwareClone(&in.Clone, &out.Clone, s); err != nil {
		return err
	}
	out.VApp = (*VApp)(unsafe.Pointer(in.VApp))
	out.WaitForGuestNetTimeout = (*int)(unsafe.Pointer(in.WaitForGuestNetTimeout))
	out.ShutdownWaitTimeout = (*int)(unsafe.Pointer(in.ShutdownWaitTimeout))
	out.RebootRequired = in.RebootRequired
	out.LatencySensitivity = in.LatencySensitivity
...
func autoConvert_v1alpha1_VMwareNetworkInterface_To_machine_VMwareNetworkInterface(in *VMwareNetworkInterface, out *machine.VMwareNetworkInterface, s conversion.Scope) error {
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_v1alpha1_VMwareNetworkInterface_To_machine_VMwareNetworkInterface is an autogenerated conversion function.
func Convert_v1alpha1_VMwareNetworkInterface_To_machine_VMwareNetworkInterface(in *VMwareNetworkInterface, out *machine.VMwareNetworkInterface, s conversion.Scope) error {
	return autoConvert_v1alpha1_VMwareNetworkInterface_To_machine_VMwareNetworkInterface(in, out, s)
}

func autoConvert_machine_VMwareNetworkInterface_To_v1alpha1_VMwareNetworkInterface(in *machine.VMwareNetworkInterface, out *VMwareNetworkInterface, s conversion.Scope) error {
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	return nil
}

// Convert_machine_VMwareNetworkInterface_To_v1alpha1_VMwareNetworkInterface is an autogenerated conversion function.
func Convert_machine_VMwareNetworkInterface_To_v1alpha1_VMwareNetworkInterface(in *machine.VMwareNetworkInterface, out *VMwareNetworkInterface, s conversion.Scope) error {
	return autoConvert_machine_VMwareNetworkInterface_To_v1alpha1_VMwareNetworkInterface(in, out, s)
}
